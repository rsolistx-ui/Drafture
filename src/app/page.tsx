...
const plans = [
  ...
  },
  {
    ...
    features: ['30 drafts per month', 'All post types', 'Readiness checks', 'Email support'],
    cta: 'Get Starter',
  ...
  },
  {
    ...
    price: '$19.99',
    period: '/month',
    description: 'For heavy weeks and multiple classes.',
    features: ['150 drafts per month', 'All post types', 'Readiness checks', 'Priority support'],
    cta: 'Go Finals',
